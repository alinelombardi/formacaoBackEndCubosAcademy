...
| nome                        | descrição                                                                                                    | preço | quantidade_em_estoque | categoria_id              |
| --------------------------- | ------------------------------------------------------------------------------------------------------------ | ----- | --------------------- | ------------------------- |
...
| Água mineral sem gás        | Smartwater é água adicionado de sais minerais (cálcio, potássio e magnésio) livre de sódio e com pH neutro.  | 130   | 478                   | `id_categoria_bebidas`    |
...
Todo script construído deverá ser disponibilizado no arquivo `query.sql` do diretório atual.
